...
export const EXPERIENCES = [
  {
    year: "2024 (Feb) - 2024 (May)",
    role: "Trainee Software Engineer",
    company: "Logical Street pvt ltd",
    description: `Contributed to the development of web applications using Ruby , JavaScript , jQuery . Managed databases and implemented data storage solutions using Squlite . Worked closely with product managers to prioritize features and enhancements.I contributed to a live project at a company, focusing on bug fixing and enhancing logic within the live website , a website offering apparel management software tailored for success in the fashion industry .`,
...
// links for images
const PROJECT_IMG = "https://plus.unsplash.com/premium_photo-1710522706751-c2f0c76cc5fd?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
...
export const PROJECTS = [
  {
    ...
    image: PROJECT_IMG,
    description:
      "Built a Ruby on Rails app with SQLite, integrating Pundit, Rolify, and Devise for authorization, role assignment, and authentication, enhanced with Bootstrap for responsive design.",
    technologies: ["HTML", "CSS", "Ruby", "Ruby on Rails", "Squlite"],
  },
  {
    title: "Student Management Application",
    image: SMA_IMG,
    description:
      "Engineered a student information CRUD system using J2SE and MySQL database.",
  ...
  },
  {
    ...
    image: EMA_IMG,
    description:
      "Designed and implemented an employee management CRUD system using Core Java.",
  ...
  },
  {
    ...
    image: ATM_IMG,
    description:
      "Created an automated teller machine simulation using Core Java.",
    technologies: ["Core Java"],
  },
  {
...
export const CONTACT = {
  address: "Ahmedabad",
  phoneNo: "+91 91576 00980 ",
  email: "dalwadidivyen15@gmail.com",
};
